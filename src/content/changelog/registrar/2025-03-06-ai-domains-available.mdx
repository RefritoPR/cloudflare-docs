...
![Example search for .ai domains](~/assets/images/changelog/registrar/2025-03-06-ai-domains-available.png)

Cloudflare Registrar now supports `.ai` and `.shop` domains. These are two of our most highly-requested top-level domains (TLDs) and are great additions to the [400+ other TLDs we support](https://domains.cloudflare.com/tlds).

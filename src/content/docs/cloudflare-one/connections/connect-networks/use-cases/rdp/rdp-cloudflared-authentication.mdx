...
title: Connect to RDP with client-side cloudflared (legacy)
sidebar:
  order: 5
  label: RDP with client-side cloudflared (legacy)
---

import { Render } from "~/components";

:::note
Not recommended for new deployments. We recommend using [Browser-based RDP](/cloudflare-one/connections/connect-networks/use-cases/rdp/rdp-browser/) or [routing over WARP](/cloudflare-one/connections/connect-networks/use-cases/rdp/rdp-warp-to-tunnel/).
:::
...
<Render file="tunnel/rdp-public-hostname" />

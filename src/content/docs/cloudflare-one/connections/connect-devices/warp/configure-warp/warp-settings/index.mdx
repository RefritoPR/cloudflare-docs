...
The only way for users to reconnect during a global override is by using a new [Admin override](#admin-override) code. For example, you can provide IT staff with a code to test resolution of the incident that led to the global disconnect.

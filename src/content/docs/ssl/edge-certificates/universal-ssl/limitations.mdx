...
sidebar:
  order: 5
description: Discover the limitations of Universal SSL certificates, including hostname coverage, CNAME setup, certificate authority, validity period, and TLS settings.
head:
  - tag: title
